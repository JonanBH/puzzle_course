...
public partial class GridManager : Node
{
    ...
    public void HighlightExpandedBuildableTiles(Vector2I rootCell, int radius)
    {
        ...
        var atlasPosition = new Vector2I(1, 0);

        foreach (var tilePosition in expandedTiles)
        {
            highlightTileMapLayer.SetCell(tilePosition, 0, atlasPosition);
        }
    }
    ...
    private void UpdateCollectedResourceTiles(BuildingComponent buildingComponent)
    {
        ...
        var validTiles = GetResourceTilesInRadius(rootCell, buildingComponent.BuildingResource.ResourceRadius);
        var oldResourceCount = collectedResourceTiles.Count;

        collectedResourceTiles.UnionWith(validTiles);
